...
export class GrWorld {
    ...
    followObjectOn()
    {
        if (this.active_object.rideable) {
            ...
            this.camera.position.set(-1.5*(bbox.max.x-bbox.min.x), bbox.max.y-bbox.min.y, 0);
            this.solo_camera.position.set( -1.5*(bbox.max.x-bbox.min.x), bbox.max.y-bbox.min.y, 0);
            // Set look direction
    ...
    driveObjectOn()
    {
        if (this.active_object.rideable) {
            ...
            this.solo_camera.rotation.set(0,-Math.PI/2,0);
